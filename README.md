...
- **Terraform** — provisioning the real AWS equivalents (RDS, SQS,
  Lambda, EventBridge, ECS Fargate for Intake) of everything
  currently running locally via Docker/LocalStack
